...
import type { MemberAccess, PlayerRecord } from '@/lib/member-access';
...
export function Portal({ member, access, players, pendingClaims }: { member: OopzSession; access: MemberAccess; players: PlayerRecord[]; pendingClaims: Claim[] }) {
